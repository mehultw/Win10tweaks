...
$tweaks = @(
	...
	### UI Tweaks ###
	"EnaableActionCenter",          # "DisableActionCenter",
...
Function InstallMTProgs{
	...
	cinst -y 7zip cpu-z AutoHotkey etcher brave networx eartrumpet firefox tor tor-browser fsviewer filezilla filezilla.server winscp click-monitor-ddc mls-software-openssh putty git windowsfirewallcontrol logitech-options rainmeter sharex sublimetext3 lockhunter vlc vscode windirstat winrar station fluent-terminal stellarium veracrypt microsoft-edge nitroshare nodejs notepadplusplus pia python quicklook stremio pip
}
